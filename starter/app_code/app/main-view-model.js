...
function createViewModel(db) {
    ...
    firebase.init({
        ...
        // todo: add code for saving device token for push notifications

        // todo: add code for processing push notifications
                ...
                setTimeout(function(){
                    ...
                    http.getJSON('https://graph.facebook.com/me/friends?access_token=' + fb_token)
                        .then(function (r) {
                            ...
                            // todo: save friends_ids locally using application settings
    ...
    viewModel.toggleTracking = function() {
        ...
        if (geolocation.isEnabled()) {
            ...
            if (viewModel.is_tracking) {
                ...
                // todo: get friends_ids from application settings

                // todo: initiate push notification
                    ...
                    function(firebase_result){
                        ...
                        if(!firebase_result.error){
                            ...
                            if(firebase_result.value == null){ 
                                ...
                                // todo: get device token from application settings

                                var user_data = {
                                    'uid': fb_result.uid,
                                    'user_name': fb_result.name,
                                    'profile_photo': fb_result.profileImageURL,
                                    // todo: add device_token
                                };
